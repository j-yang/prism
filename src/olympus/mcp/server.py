...
Exposes Olympus capabilities as MCP tools for integration with OpenCode, Claude, etc.
"""
...
def load_meta(meta_path: str, db_path: Optional[str] = None) -> str:
    ...
    from olympus.meta.loader import load_specs_to_meta
    from olympus.meta.schema import generate_meta_ddl
...
def generate_silver(
    ...
    """
    from olympus.silver.agent import SilverAgent
...
def generate_gold(
    ...
    """
    from olympus.gold.agent import GoldAgent
...
def extract_mock_shell(mock_path: str, output_path: Optional[str] = None) -> str:
    ...
    from olympus.meta.extractor import extract_mock_shell as extract
...
def list_silver_transforms() -> str:
    ...
    """
    from olympus.transforms import list_transforms
...
def get_transform_code(transform_name: str) -> str:
    ...
    from olympus.transforms import get_transform
...
def generate_platinum(
    ...
    from olympus.platinum.renderer import PPTXRenderer
